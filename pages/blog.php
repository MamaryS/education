		   			...
		   			<div class="row">
			   			<div class="col-md-8 col-md-offset-2 text-center slider-text">
			   				<div class="slider-text-inner">
			   					<h1 class="heading-section">Nos établissements</h1>
...
<?php endforeach; ?> 
				<!--<div class="col-lg-4 col-md-4 ">
					<div class="fh5co-blog animate-box">
						...
						<div class="blog-text">
							<h3><a href="#">Abderhamane Baba Touré National School of Engineers</a></h3>
				...
				<div class="col-lg-4 col-md-4">
					<div class="fh5co-blog animate-box">
						...
						<div class="blog-text">
							<h4><a href="#">Lycée Sacré-Coeur Baco-Djicoroni</a></h4>
							<span class="posted_on">college</span>
							<span class="comment"><a href="">21<i class="icon-speech-bubble"></i></a></span>
				...
				<div class="col-lg-4 col-md-4">
					<div class="fh5co-blog animate-box">
						...
						<div class="blog-text">
							<h4><a href="https://www.kodonso.net/">Lycée KODONSO</a></h4>
							<span class="posted_on">Lycée</span>
							<span class="comment"><a href="">21<i class="icon-speech-bubble"></i></a></span>
				...
				<div class="col-lg-4 col-md-4">
					<div class="fh5co-blog animate-box">
						...
						<div class="blog-text">
							<h4><a href="https://lyceelescastors.com/">Lycée les Castors</a></h4>
							<span class="posted_on">Lycée</span>
							<span class="comment"><a href="">21<i class="icon-speech-bubble"></i></a></span>
				...
				<div class="col-lg-4 col-md-4">
					<div class="fh5co-blog animate-box">
						<a href="#" class="blog-img-holder" style="background-image: url(../images/person1.jpg);"></a>
						<div class="blog-text">
							<h4><a href="#">Lycée El-Madani Dravé Lafiabougou</a></h4>
							<span class="posted_on">Lycée</span>
							<span class="comment"><a href="">21<i class="icon-speech-bubble"></i></a></span>
				...
				<div class="col-lg-4 col-md-4">
					<div class="fh5co-blog animate-box">
						...
						<div class="blog-text">
							<h4><a href="https://www.libertebko.org/">Établissement Liberté Bamako MALI</a></h4>
							<span class="posted_on">Lycée</span>
							<span class="comment"><a href="">21<i class="icon-speech-bubble"></i></a></span>
				...
				<div class="col-lg-4 col-md-4">
					<div class="fh5co-blog animate-box">
						<a href="#" class="blog-img-holder" style="background-image: url(../images/person1.jpg);"></a>
						<div class="blog-text">
							<h4><a href="#">Lycée Mamadou M'bodji De Sébénikoro</a></h4>
							<span class="posted_on">Lycée</span>
							<span class="comment"><a href="">21<i class="icon-speech-bubble"></i></a></span>
