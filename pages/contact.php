...
<html>
	...
	<title>Contact &mdash; EducMali.</title>
...
<?php require('../php/nav.php'); ?>
				...
				<div class="col-md-5 col-md-push-1 animate-box">
					...
					<div class="fh5co-contact-info">
						...
						<ul>
							...
							<li class="url"><a href="">AMARY</a></li>
						</ul>
					</div>
					...
					<form action="#">
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input type="text" id="subject" class="form-control" placeholder="Your subjec">
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<textarea name="message" id="message" cols="30" rows="10" class="form-control" placeholder="Dis quelque chose sur nous"></textarea>
							</div>
						</div>
						<div class="form-group">
							<input type="submit" value="Envoie du Message" class="btn btn-primary">
						</div>
	...
	<div id="map" class="fh5co-map"><iframe width="600" height="500" id="gmap_canvas" src="https://maps.google.com/maps?q=Mali%20bamako&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe></div>
